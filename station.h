...
#include <stdint.h>
#include <stdbool.h>
typedef enum {TEMPR_EVENT = 0,  MOTION_EVENT, CHECKCHARGE_EVENT, BLINK_EVENT, BLINK2_EVENT, BLINK3_EVENT, SIMPROCESS_EVENT, SIMRX_WATCH_EVENT, SIM_POSTPONE_WATCH_EVENT, TEMPR_STREAM_EVENT, TEMPR_MEASURE_EVENT, AUTOSTART_EVENT, LINK_QUALITY_EVENT, BUTTON_EVENT, SERVICE_PROVIDER_EVENT, TIME_REFRESH_EVENT} TEvent;
